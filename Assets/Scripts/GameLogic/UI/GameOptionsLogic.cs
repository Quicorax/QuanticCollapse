...
namespace QuanticCollapse
{
    public class GameOptionsLogic : MonoBehaviour
    {
        ...
        [SerializeField] private BlackCircleTransition _transition;
        ...
        public void ShowCredits()
        {
            _popUps.SpawnPopUp(transform.parent, new IPopUpComponentData[]
            {
                ...
                _popUps.AddText("<align=\"left\"><indent=5%><i>Quantic Collapse</i> " +
                                _localization.Localize("LOBBY_MAIN_CREDITS_ASSETS")),
